...
$("[id^=clrBtn").on("click",function(){var e=this.id.slice(-1);autocompRedraw("nul",e),CalcTotals(e),recolor("",e),DTRedraw(),$("#squadMembr"+e+" .assigned tbody").css("display","none"),$("[id^=hideShow"+e).attr("value","Hide")}),$(".filterUp, .lrgFilterUp, .filterDwn, .lrgFilterDwn").on("click",function(){switch($(this).attr("label")){case"Slot":var e=1;break;case"Set":e=2}if(""===$("#moddata").DataTable().columns(e).search()[0]||"lrgFilter"==$(this).attr("class"))$("#moddata").DataTable().columns(e).search($(this).attr("name"),1,0,1),DTRedraw();else if($(this).attr("class").includes("Up")){var s=$("#moddata").DataTable().columns(e).search()[0]+"|"+$(this).attr("name");$("#moddata").DataTable().columns(e).search(s,1,0,1),DTRedraw()}else{s=$("#moddata").DataTable().columns(e).search()[0].replace($(this).attr("name"),"");splitVar=s.split("|").filter(e=>""!==e),s=splitVar.join("|"),$("#moddata").DataTable().columns(e).search(s,1,0,1),DTRedraw()}switch($(this).attr("class")){case"filterUp":$(this).toggleClass("filterUp"),$(this).toggleClass("filterDwn");break;case"lrgFilterUp":switch($(this).toggleClass("lrgFilterUp"),$(this).toggleClass("lrgFilterDwn"),e){case 1:$("[label=Slot][name!=Arr][id!=allBut]").addClass("filterDwn").removeClass("filterUp");break;case 2:$("[label=Set][name!=Dam][name!=Off][name!=Spe][id!=2pcSets]").addClass("filterDwn").removeClass("filterUp")}break;case"filterDwn":$(this).toggleClass("filterUp"),$(this).toggleClass("filterDwn");break;case"lrgFilterDwn":switch($(this).toggleClass("lrgFilterUp"),$(this).toggleClass("lrgFilterDwn"),e){case 1:$("[label=Slot][name!=Arr][id!=allBut]").addClass("filterUp").removeClass("filterDwn");break;case 2:$("[label=Set][name!=Dam][name!=Off][name!=Spe][id!=2pcSets]").addClass("filterUp").removeClass("filterDwn")}}}),$("#clrFilters").on("click",function(){$(".filterDwn").removeClass("filterDwn").addClass("filterUp"),$(".lrgFilterDwn").removeClass("lrgFilterDwn").addClass("lrgFilterUp"),$("#moddata").DataTable().columns().search("").draw()})});